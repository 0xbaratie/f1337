  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-center mt-8">
        <a
          href={`https://warpcast.com/~/compose?text=The number is ${numberAsString}. F1337 is a fully onchain game for only Farcaster users. Let's try the on-chain experiment!+f1337.vercel.app`}
          target="_blank"
